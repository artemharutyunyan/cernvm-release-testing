...
\include{content/testclient}
\include{content/default/testclient_windows}
\include{content/default/testclient_redhat}
\include{content/default/testclient_debian}
\include{content/default/testclient_osx}
\include{content/server}
% Red Hat not fully supported by Tapper Deployment yet
%\include{content/default/server_redhat}
\include{content/default/server_debian}
\include{content/default/server_ubuntu}
