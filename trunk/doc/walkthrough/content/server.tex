...
installer/tapper-deployment cernvm-release-testing-read-only
\end{lstlisting}
...
\item 	After you have configured the Makefile in the installer folder, install Tapper-Starterkit by executing the
...
\begin{comment}
%
% THIS SECTION NEEDS TO BE VERIFIED AND TESTED, THESE PROCEDURES MOST LIKELY DON'T WORK FOR ALL RED HAT SYSTEMS
%
...
\item 	Now, download the latest copy of the Tapper-Starterkit, which is an installer for Tapper from the \cernvmreleasetesting 
		Google Code Project page
